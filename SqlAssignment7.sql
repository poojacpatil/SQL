...
update Customers set Postalcode=null where CustId=2
update Customers set Postalcode=null where CustId=11
...
--Use the BETWEEN operator to select all the records where the value of the Price column is between 20000 and 28000
select * from Customers where Price between 20000 and 28000

--Use the BETWEEN operator to select all the records where the value of the Price column is NOT between 20000 and 30000.
select * from Customers where Price not between 20000 and 30000
